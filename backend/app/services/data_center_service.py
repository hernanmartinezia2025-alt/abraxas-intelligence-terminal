...
SOURCE_CATALOG = [
    ...
    },
    {
        ...
        "type": "market",
        "status": "active",
        "datasets": ["market_snapshots", "market_candles", "market_aggregate_trades", "order_book_snapshots", "order_book_levels"],
...
DATASET_CATALOG = [
    ...
    },
    {
        ...
        "powerbi_ready": True,
        "bot_ready": False,
        "description": "Cabeceras persistidas de snapshots puntuales Binance Depth; no son deltas L2 continuos.",
    },
    {
