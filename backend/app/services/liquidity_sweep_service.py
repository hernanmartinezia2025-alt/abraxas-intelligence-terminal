...
def readiness() -> dict:
    return {
        ...
        "order_allowed": False,
        "available": ["closed_ohlcv", "closed_candle_volume", "squeeze_adx", "current_l2_snapshot", "closed_candle_aggregate_trade_flow", "persisted_l2_snapshots"],
        "missing": ["continuous_websocket_trade_flow", "continuous_l2_deltas", "liquidation_clusters"],
